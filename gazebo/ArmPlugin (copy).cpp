...
#define INPUT_CHANNELS 3   // originally 3
...
#define REWARD_WIN  20.0f    // start with a value of 20
#define REWARD_LOSS -20.0f   // start with a value of -20
#define INTERIM_REWARD 4.0f
#define INTERIM_OFFSET 0.3f
#define ALPHA 0.4f          // start with a value of 0.4f
...
bool ArmPlugin::createAgent()
{
	...
	*/
    ...
    agent = dqnAgent::Create(INPUT_WIDTH, INPUT_HEIGHT, INPUT_CHANNELS, DOF * 2, OPTIMIZER, LEARNING_RATE, REPLAY_MEMORY, BATCH_SIZE, 
                             GAMMA, EPS_START, EPS_END, EPS_DECAY, USE_LSTM, LSTM_SIZE, ALLOW_RANDOM, DEBUG_DQN);
...
bool ArmPlugin::updateAgent()
{
	...
	*/
	...
	/
	*/
    // TODO - Set the joint position based on whether action is even or od
